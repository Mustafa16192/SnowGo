...
export function OnboardingResident2() {
      ...
      <div className="h-[calc(100%-44px)] bg-gray-50 flex flex-col">
        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
          ...
          <p className="text-gray-600 mb-2">
            Get notified when a volunteer accepts your request.
          </p>
          <p className="text-gray-600">
            You can contact them if needed, or just wait for them to arrive.
          </p>
        </div>
        ...
        <div className="p-6 space-y-3">
          ...
          <PrimaryButton 
            fullWidth
            onClick={() => navigate('/onboarding/resident/3')}
          >
            Next
          </PrimaryButton>
          <PrimaryButton 
