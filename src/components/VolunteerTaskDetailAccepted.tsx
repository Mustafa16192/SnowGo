...
export function VolunteerTaskDetailAccepted() {
  return (
    <PhoneFrame>
      <StatusBar />
        ...
        <div className="p-4 space-y-4">
          ...
          <Card>
            <div className="flex justify-between items-start mb-3">
              ...
              <span className="inline-block px-3 py-1 bg-teal-100 text-teal-800 rounded-full text-sm ml-3 flex-shrink-0">
                Accepted
              </span>
            </div>
          </Card>
          ...
          <Card>
            ...
            <div className="text-gray-700 mb-3">No contact needed</div>
