...
export function ResidentMap() {
  return (
    <PhoneFrame>
      ...
      {/* Map Container - Fits exact space between header and bottom nav */}
      <div className="h-[calc(100%-180px)] bg-gray-50 relative">
        {/* Map Area */}
        <div className="h-full bg-gradient-to-br from-blue-50 to-blue-100 relative overflow-hidden">
          ...
          {/* Place Labels */}
          <div className="absolute top-20 left-8 text-gray-700 font-medium">Downtown</div>
          <div className="absolute top-44 right-12 text-gray-700 font-medium">Campus</div>
          <div className="absolute bottom-36 left-12 text-gray-700 font-medium">Stadium</div>
          <div className="absolute top-56 left-32 text-gray-700 font-medium">Main St</div>

          {/* Your area marker */}
          <div className="absolute top-40 left-48 flex flex-col items-center z-10">
            <div className="bg-teal-600 rounded-full p-2 shadow-lg">
              <Home className="w-5 h-5 text-white" />
            </div>
            <div className="mt-1 text-teal-900 bg-white px-2 py-0.5 rounded shadow-sm text-xs font-bold">
              Your area
            </div>
          </div>
